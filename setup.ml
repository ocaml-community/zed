...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0e9021a01dec69d64732a5ef74a3f572) *)
(*
     ...
     package =
       {
          ...
          synopsis = "Zed";
          description =
            Some "An edition engine for editors, text widgets, ...";
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("react", None)];
